...
This project is indexed by GitNexus as **presentation-page** (282 symbols, 475 relationships, 7 execution flows).
...
| Resource | Use for |
| --- | --- |
| `gitnexus://repo/presentation-page/context` | Codebase overview, check index freshness |
| `gitnexus://repo/presentation-page/clusters` | All functional areas |
| `gitnexus://repo/presentation-page/processes` | All execution flows |
| `gitnexus://repo/presentation-page/process/{name}` | Step-by-step execution trace |
